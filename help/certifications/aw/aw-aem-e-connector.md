...
description: Découvrez comment devenir un expert certifié Adobe dans Adobe [!DNL Workfront] pour [!DNL Experience Manager]
solution: Workfront
role: Developer
...
Découvrez comment devenir un expert certifié en Adobe.
...
* [Comprendre le multi-location et le développement simultané](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/deployment/multitenancy-concurrent-article-understand.html?lang=en){target="_blank"}
...
* [Dépannage avancé avec l’outil de développement](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/fusion/troubleshooting-and-error-handling/advanced-troubleshooting-with-the-dev-tool.html?lang=en){target="_blank"}
...
* [Adobe [!DNL Experience Manager Assets] intégration avec Adobe [!DNL Workfront]](https://experienceleague.adobe.com/docs/experience-manager-65/assets/integrations/workfront-integrations.html?lang=fr){target="_blank"}
...
* [Installer [!DNL Workfront] pour [!DNL Experience Manager] connecteur amélioré](https://experienceleague.adobe.com/docs/experience-manager-64/assets/integrations/workfront-connector-install.html?lang=fr){target="_blank"}

**Section 3 : Pratiques commerciales**

* [Développer une [!DNL Workfront] Stratégie DAM](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/workfront-dam-program/system-setup/analyze-and-plan-to-develop-a-workfront-dam-strategy.html?lang=en){target="_blank"}
...
* [Vérifier et approuver un BAT](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/workfront-proof/review-and-approve-work-for-proof/review-and-approve-a-proof.html?lang=en){target="_blank"}
...
* [Installer [!DNL Workfront] pour [!DNL Experience Manager] connecteur amélioré](https://experienceleague.adobe.com/docs/experience-manager-65/assets/integrations/workfront-connector-install.html?lang=fr){target="_blank"}
...
* [Configurer [!DNL Workfront] pour [!DNL Experience Manager] connecteur amélioré](https://experienceleague.adobe.com/docs/experience-manager-65/assets/integrations/workfront-connector-configure.html?lang=fr){target="_blank"}
* [Adobe [!DNL Experience Manager Assets] intégration avec Adobe [!DNL Workfront]](https://experienceleague.adobe.com/docs/experience-manager-65/assets/integrations/workfront-integrations.html?lang=fr){target="_blank"}
...
### Numéro de l’examen : AD0-E906

[!BADGE PSI]{type=Informative url="https://www.certmetrics.com/adobe/candidate/psi_sso_adobe.aspx?redir=yes&amp;ec=AD0-E906 newtab=true"}[!BADGE Examiner]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E906 newtab=true"}

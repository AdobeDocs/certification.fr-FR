...
description: Découvrez comment devenir un expert en métier certifié en Adobe [!DNL Experience Manager Sites].
...
* [Concepts de base des composants](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/project-archetype/component-basics.html?lang=en){target="_blank"}

...
* [Comment s’inscrire à un examen dans un centre de test](https://express.adobe.com/page/C8QDu4upy4gF3/){target="_blank"}
...
Votre [profile](https://www.certmetrics.com/adobe/candidate/demographics.aspx){target="_blank"} Le nom dans le système de gestion des informations d’identification d’Adobe doit correspondre exactement à votre ID d’administration. Si vous ne disposez pas d&#39;informations identiques ou d&#39;une discordance, le prestataire mettra fin à l&#39;examen et vous obligera à reprogrammer votre rendez-vous en plus de payer des frais d&#39;examen supplémentaires.
...
Vous pouvez appliquer le code du bon lorsque vous planifiez votre examen. Si vous avez une remise, elle est appliquée au passage en caisse.

**Remises pour les partenaires**

Les partenaires Bronze et plus bénéficient de remises sur tous les examens et classes de certification d’Adobe. Vous pouvez en savoir plus sur ces réductions et sur la manière d’accéder aux avantages pour les partenaires sur la page [Portail Partenaires en solutions](https://solutionpartners.adobe.com/solution-partners/home/learn/credentials/certification/certification_exam_registration_and_management.html?nav=cost){target="_blank"}.

**Autres remises**

De plus, tous les candidats peuvent bénéficier d’une remise sur les achats en masse de 10 examens ou plus lorsqu’ils effectuent un achat via le [Centre des bons de certification Adobe](https://market.xvoucher.com/adobe/global){target="_blank"}.
...
* [Guide d’analyse du processus en ligne](https://www.examity.com/online-proctoring-troubleshooting-guide-for-test-takers-v4/){target="_blank"}
...
* [Premier utilisateur de test](https://vimeo.com/394506654){target="_blank"}
...
* [Comment tester en ligne](https://vimeo.com/394506686){target="_blank"}
...
* Exemple : Lorsque vous achetez 10 bons d&#39;examen de niveau Adobe Certified Expert et que vous les distribuez, vous n&#39;avez pas à prévoir à l&#39;avance qui va passer l&#39;examen d&#39;expert.
...
+++Comment puis-je accéder à mon compte Xvoucher ?
...
Les sections et liens suivants ne fonctionneront qu’après une connexion réussie à [Système de gestion des informations d’identification Adobe](https://www.certmetrics.com/adobe){target="_blank"}.

| Liens rapides | Description |
| ------- | ------- | 
| Adobe Credential Management System | [Connexion initiale à Adobe Credential Management](https://www.certmetrics.com/adobe){target="_blank"} |
| Profile | [Page d’informations démographiques avec l’emplacement du nom du compte, de l’adresse, de la société, etc. Les noms ne peuvent être mis à jour qu’en tant qu’administrateur Adobe](https://www.certmetrics.com/adobe/candidate/demographics.aspx){target="_blank"}. |
...
| Historique | [Afficher le rapport et l’historique des examens](https://www.certmetrics.com/adobe/candidate/cert_summary.aspx){target="_blank"} |
...
* **Étape 1 :** Se connecter [Creative](https://www.credly.com/users/sign_in){target="_blank"}. _(Vous devez utiliser le même e-mail que celui utilisé pour obtenir vos informations d’identification d’Adobe, sinon vous ne verrez pas votre badge.)_

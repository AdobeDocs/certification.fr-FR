...
* **Étape 1 :** Connectez-vous à la [Système de gestion des informations d’identification Adobe](https://www.certmetrics.com/adobe){target="_blank"}.
...
* **Étape 4 :** Suivez les étapes fournies sous la section **Obtenir une certification** .
...
| ------- | ------- | 
| Système de gestion des informations d’identification Adobe | [Connexion initiale à Adobe Credential Management](https://www.certmetrics.com/adobe){target="_blank"} |

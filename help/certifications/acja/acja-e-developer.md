...
description: Découvrez comment devenir un expert certifié dans  [!DNL Customer Journey Analytics]
role: User
...
# Parcours de certification pour l’expert en développement Adobe [!DNL Customer Journey Analytics]

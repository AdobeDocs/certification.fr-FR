...
description: Prise en main d’ [!DNL Experience Cloud] certifications. Découvrez le programme et comment parcourir les pages de notre site.
...
Les certifications d’Adobe sont conçues pour valider les connaissances et les compétences des professionnels qui travaillent avec nos solutions de marketing numérique.

Prise en main des certifications techniques. Découvrez le programme et comment parcourir les pages de notre site.
...
| Exemples de questions | Pour certains examens de certification, l’Adobe ne dispose pas encore de tests d’entraînement complets. Pour ces examens, un ensemble représentatif de questions est fourni. |
...
| ![Badge d’architecte](/help/certifications/assets/architect_blk_small.png) | **Architectes** sont chargés de concevoir et de mettre en oeuvre des solutions de niveau entreprise à l’aide d’Adobe ; [!DNL Experience Cloud] solutions. Ils doivent posséder une connaissance approfondie des solutions de marketing numérique d’Adobe et une expérience approfondie de l’architecture, de l’intégration et de la personnalisation des logiciels. La certification Architect valide leur capacité à concevoir et mettre en oeuvre des solutions complexes à l’aide des solutions de marketing numérique d’Adobe. |
| ------- | ------- |

>[!TAB Parcours de certification]

Le Guide du Parcours de certification est un outil complet conçu pour vous fournir toutes les informations dont vous avez besoin pour vous préparer à un examen de certification. Le guide est divisé en trois sections principales : Préparez-vous, préparez-vous et soyez certifié.

| Sections | Description |
| ------- | ------- |
| **Préparez-vous** | Il a pour but de donner un aperçu de l’examen, y compris des informations sur le public visé, les détails de l’examen, l’auto-évaluation de la préparation, les objectifs et la portée de l’examen. Cette section vous aide à comprendre l’examen et ce à quoi vous pouvez vous attendre lorsque vous le prenez. L’auto-évaluation de la préparation est particulièrement utile, car elle vous permet de déterminer votre niveau actuel de connaissances et d’identifier les domaines dans lesquels vous devrez peut-être concentrer vos efforts d’étude. |
| **Obtenir la préparation** | C’est là que vous pouvez trouver des formations et des ressources pour vous aider à vous préparer à l’examen. Cette section contient des informations et des liens vers des documents d&#39;études et des cours de formation. |
| **Obtenir une certification** | Offre des informations précieuses sur la façon de s’inscrire à l’examen de certification, y compris des détails sur le processus d’inscription et les méthodes de paiement disponibles. En outre, cette section donne un aperçu clair du processus d’examen. Reportez-vous à cette section pour obtenir des ressources utiles, telles qu’un lien vers le portail de préparation de certification Adobe pour les examens qui offrent des tests d’expérience, ainsi que des liens permettant de s’inscrire aux examens de certification. |

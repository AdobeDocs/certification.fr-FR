...
Le programme de redémarrage des Adobes est une initiative qui permet aux individus dont le délai d’expiration est expiré [!DNL Experience Cloud] certifications à certifier, gratuites. Si vous avez déjà détenu une certification Adobe Experience Cloud expirée depuis, vous pouvez être autorisé à redémarrer votre certification via des formats de test GRATUITS et non traités. Ce programme est une ressource précieuse pour les personnes qui souhaitent améliorer leurs connaissances et compétences du Adobe Experience Cloud et rester compétitives.

### Étapes à suivre pour redémarrer votre certification expirée{#exams}

>[!NOTE]
>
>Si vous avez reçu un e-mail du programme d’identification d’Adobe comportant le sujet &quot;Devenez un Adobe certifié à nouveau gratuitement&quot;, vous pouvez passer à l’étape 2.

* Étape 1 : Déterminez si votre certification expirée est éligible au programme Redémarrer en cochant [here](https://solutionpartners.adobe.com/solution-partners/training_and_certification/certification.html#restart){target="_blank"}. S’il est éligible, passez à l’étape 2.
* Étape 2 : Vérifiez les exigences de redémarrage de votre application.
* Étape 3 : Suivez les étapes pour terminer les évaluations/examens du cours. **avant le 20 octobre 2023,** échéance parmi les options fournies.

### Adobe de la certification Redémarrez les chemins par application
...
Pour certains Adobes [!DNL Experience Cloud] certifications, le programme d’identification des Adobes accepte les **Références client** qui valident votre travail en tant que personne certifiée Adobe dirigeant, gérant et/ou participant sur un Adobe [!DNL Experience Cloud] projet de mise en oeuvre.

Dans ce cas, vous pouvez fournir une référence client confirmant que vous avez participé à au moins 100 heures d’engagement de projet démontré au cours des 12 derniers mois.

**Une fois votre référence client vérifiée, vous en serez informé par l’équipe d’informations d’identification de l’Adobe.**


Les évaluations du cours sont gratuites. Il n&#39;est pas nécessaire de les planifier, et ils ne sont pas traités. Si vous détenez plusieurs certifications Adobe Experience Manager au niveau des experts et des Principal, vous n’aurez qu’à répondre aux exigences ci-dessous et vos certifications d’AEM expert et maître seront renouvelées.
...
| ------- | ------- |
| [Passage à Adobe Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/courses/using/experiencemanager-d-1-2021-1-migration.html?lang=en){target="_blank"} | [ADS-EA101](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-EA101){target="_blank"} |
...
| [Gestion de contenu headless à l’aide des API GraphQL](https://experienceleague.adobe.com/docs/courses/using/experiencemanager-d-1-2020-1-headless.html?lang=en){target="_blank"} | [ADS-EA104](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-EA104){target="_blank"} |
...
| [Adobe Experience Manager Sites pour les architectes](https://experienceleague.adobe.com/docs/courses/using/experiencemanager-d-1-2019-1-architect.html?lang=en){target="_blank"} | [ADS-EA108](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-EA108){target="_blank"} |

>[!NOTE]
>
>Vous pouvez répéter jusqu’à ce que vous ayez terminé trois activités ou terminé deux activités et le formulaire de référence du client.
...
Les évaluations du cours sont gratuites. Il n&#39;est pas nécessaire de les planifier, et ils ne sont pas traités. Si vous détenez plusieurs certifications d’expert et de Principal Adobe, vous n’aurez qu’à remplir les exigences ci-dessous et vos certifications d’expert et de maître Analytics seront renouvelées.

[Formulaire de référence client pour Adobe Analytics](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-EA200){target="_blank"}
...
| [ Mise en oeuvre et mesure de la recherche de site interne - Leçon 3 et 4](https://experienceleague.adobe.com/?recommended=Analytics-U-1-2021.1.search){target="_blank"} | [ADS-EA205](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-EA205){target="_blank"} |
| [API Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/apis/using-analysis-workspace-to-build-api-2-requests.html?lang=en){target="_blank"} | [ADS-EA206](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-EA206){target="_blank"} |
...
**Une fois la référence de votre client vérifiée, vous en serez informé par l’équipe d’informations d’identification de l’Adobe.**

Les évaluations du cours sont gratuites. Il n&#39;est pas nécessaire de les planifier, et ils ne sont pas traités. Si vous détenez plusieurs certifications Adobe Target au niveau des experts et des Principal, vous n’aurez qu’à répondre aux exigences ci-dessous et vos certifications Target expert et maître seront renouvelées.

[Formulaire de référence client pour Adobe Target](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-EA400){target="_blank"}
...
* [[!DNL Audience Manager] Documentation du produit](https://docs.adobe.com/content/help/fr-FR/audience-manager/user-guide/aam-home.html){target="_blank"}
...
[!BADGE Souscrivez à l’examen de redémarrage ADS-E826 de l’expert du métier de Adobe Audience Manager]{type=Informative url="https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-E826 newtab=true"}

+++

+++ADS-E825 Adobe Audience Manager **Architecte** examen de redémarrage principal
...
* Langues disponibles : Anglais
* Coût : GRATUIT
* ID d’examen : ADS-E825 - Redémarrage du Principal Adobe Audience Manager Architect
...
* [Tutoriels sur l’Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/overview.html?lang=fr){target="_blank"}
...
[!BADGE Réalisez l’examen principal de redémarrage de Adobe Audience Manager Architect ADS-E825]{type=Informative url="https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-E825 newtab=true"}
...
* [Création d’une ressource personnalisée (vidéo)](https://experienceleague.adobe.com/docs/campaign-standard-learn/creating-custom-resources/creating-a-custom-resource.html?lang=en){target="_blank"}
* [Création d’une ressource](https://experienceleague.adobe.com/docs/campaign-standard/using/developing/adding-or-extending-a-resource/creating-or-extending-the-resource.html?lang=en){target="_blank"}
* [Configuration de la définition et du filtrage d’écran (vidéo)](https://experienceleague.adobe.com/docs/campaign-standard-learn/creating-custom-resources/configuring-a-screen-definition-for-a-custom-resource.html?lang=en){target="_blank"}
* [Configurer la définition d’écran](https://experienceleague.adobe.com/docs/campaign-standard/using/developing/adding-or-extending-a-resource/configuring-the-screen-definition.html?lang=en){target="_blank"}
* [Configuration du filtrage](https://experienceleague.adobe.com/docs/campaign-standard/using/developing/adding-or-extending-a-resource/configuring-the-screen-definition.html?lang=en){target="_blank"}
* [Création d’un lien personnalisé (vidéo)](https://experienceleague.adobe.com/docs/campaign-standard-learn/creating-custom-resources/linking-custom-resources.html?lang=en){target="_blank"}
* [Configuration des clés, des index et des liens](https://experienceleague.adobe.com/docs/campaign-standard/using/developing/adding-or-extending-a-resource/configuring-the-resource-s-data-structure.html?lang=en#defining-links-with-other-resources){target="_blank"}
...
* [Mettre à jour et publier une ressource](https://experienceleague.adobe.com/docs/campaign-standard/using/developing/adding-or-extending-a-resource/updating-the-database-structure.html?lang=en){target="_blank"}
* [Dépannage de la modélisation des données](https://experienceleague.adobe.com/docs/campaign-standard/using/developing/adding-or-extending-a-resource/updating-the-database-structure.html?lang=en){target="_blank"}
...
* [Créer une campagne](https://experienceleague.adobe.com/docs/campaign-standard/using/getting-started/marketing-plans/programs-and-campaigns.html?lang=en){target="_blank"}
...
* [Créer et gérer des modèles](https://experienceleague.adobe.com/docs/campaign-standard/using/getting-started/marketing-plans/marketing-activity-templates.html?lang=en){target="_blank"}
...
* [Canaux pour envoyer une diffusion](https://experienceleague.adobe.com/docs/campaign-standard/using/communication-channels/about-communication-channels/key-steps-to-send-a-message.html?lang=en){target="_blank"}
* [Tracking et suivi d&#39;une diffusion](https://experienceleague.adobe.com/docs/campaign-standard/using/communication-channels/delivery-bestpractices/track-and-monitor.html?lang=en){target="_blank"}
...
* [Découvrir le concepteur d’email (vidéo)](https://experienceleague.adobe.com/docs/campaign-standard/using/designing-content/designing-content-in-adobe-campaign.html?lang=en#video){target="_blank"}
...
* [Personnaliser vos rapports](https://experienceleague.adobe.com/docs/campaign-standard/using/reporting/get-started-reporting.html?lang=en){target="_blank"}
...
* [Groupes de sécurité](https://experienceleague.adobe.com/docs/campaign-standard/using/administrating/users-and-security/managing-groups-and-users.html?lang=fr)
...
* [Gestion des packages](https://experienceleague.adobe.com/docs/campaign-standard/using/managing-processes-and-data/importing-and-exporting-data/managing-packages.html?lang=en)
* [Export / import de ressources personnalisées](https://experienceleague.adobe.com/docs/campaign-standard/using/managing-processes-and-data/importing-and-exporting-data/exporting-importing-custom-resources.html?lang=en)
* [Comptes externes](https://experienceleague.adobe.com/docs/campaign-standard/using/administrating/application-settings/external-accounts.html?lang=en)
...
* [Surveiller l’exécution des workflows](https://experienceleague.adobe.com/docs/campaign-standard/using/managing-processes-and-data/executing-a-workflow/monitoring-workflow-execution.html?lang=fr)
* [Créer une nouvelle marque](https://experienceleague.adobe.com/docs/campaign-standard/using/administrating/application-settings/branding.html?lang=en)
* [À propos de la configuration des canaux](https://experienceleague.adobe.com/docs/campaign-standard/using/administrating/configuring-channels/about-channel-configuration.html?lang=en)
* [Prise en main des canaux de communication](https://experienceleague.adobe.com/docs/campaign-standard/using/communication-channels/get-started-communication-channels.html?lang=en)

### Redémarrez votre certification.

Cet examen est gratuit, il est ouvert et il n&#39;est pas traité. Vous pouvez passer l&#39;examen jusqu&#39;à trois fois. Si vous échouez après la troisième tentative, vous devez attendre **30 jours** pour réessayer. Si vous ne vous y conformez pas, votre certification risque d’être révoquée.

[!BADGE Prenez l’Adobe [!DNL Campaign Standard] Examen de redémarrage des développeurs ADS-821]{type=Informative url=&quot;https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-E821 newtab=true&quot;}
...
* Langues disponibles : Anglais
* Coût : GRATUIT
* ID d’examen : ADS-E822 - Redémarrage de l’expert du métier Campaign Standard
...
* Etant donné les exemples d&#39;exigences, concevez et configurez une diffusion
* Appliquer les bonnes pratiques en matière de conception de diffusion
* Application des dernières fonctionnalités du Concepteur d&#39;email
...
[!BADGE Prenez l’Adobe [!DNL Campaign Standard] Examen de redémarrage expert du professionnel ADS-822]{type=Informative url=&quot;https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-E822 newtab=true&quot;}

+++

+++ADS-E823 Adobe **Campaign Classic** examen expert et/ou maître de redémarrage
...
* Langues disponibles : Anglais
* Coût : GRATUIT
* ID d’examen : ADS-E823 - Adobe [!DNL Campaign Classic] expert et/ou redémarrage maître
...
* [ [!DNL Campaign Classic]  [!DNL Campaign] Passer de la v7 à la v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/v7-to-v8.html?lang=en){target="_blank"}
...
[!BADGE Souscrivez à l’examen de redémarrage Adobe Campaign Classic ADS-823]{type=Informative url="https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-E823 newtab=true"}
...
* Interprétation de la relation entre les programmes, les canaux, les balises et le coût de la période
...
* [Experience League - Documentation du produit Marketo Engage](https://experienceleague.adobe.com/docs/marketo/using/home.html?lang=fr){target="_blank"} (Création de rapports, informations sur les performances, rapport sur les performances des programmes, modification des rapports, adhésion au programme)
...
* [Experience League - [!DNL Marketo Engage] Documentation du produit](https://experienceleague.adobe.com/docs/marketo/using/home.html?lang=fr){target="_blank"} (Utilisation de programmes, de marketing par e-mail, de tests A/B)
...
[!BADGE Souscrivez à l’examen de redémarrage de l’expert du métier Adobe Marketo Engage ADS-E824]{type=Informative url="https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADS-E824 newtab=true"}

...
description: Découvrez comment devenir un spécialiste certifié Adobe en  [!DNL Adobe Target].
solution: Target
product: Target
role: User
...
# Parcours de certification pour [!DNL Adobe Target] spécialiste des professionnels

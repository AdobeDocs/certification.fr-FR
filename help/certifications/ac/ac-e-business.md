...
description: Découvrez comment obtenir une certification en tant que spécialiste des pratiques commerciales Adobe dans Adobe [!DNL Commerce].
solution: Commerce
product: Magento
role: User
level: Experienced
...
# Parcours de certification pour [!DNL Adobe Commerce] spécialiste des professionnels
